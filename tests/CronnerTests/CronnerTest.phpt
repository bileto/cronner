...
use CronnerTests\TestObjects\AnotherSimpleTestObject;
use CronnerTests\TestObjects\NextSimpleTestObject;
use CronnerTests\TestObjects\SameTaskNameObject;
use CronnerTests\TestObjects\TestExceptionObject;
